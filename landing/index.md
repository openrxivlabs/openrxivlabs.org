...
Successful experiments may be integrated into the core openRxiv platform. But all experiments will publish results openly on the openRxiv Labs blog so that the community can learn from them.
...
- **Collaborative.** Experiments must be conducted with at least one values-aligned partner, which could be a funder providing a grant and we’re doing the work.
...
- **Demonstrate a core commitment to open science principles and practices.** Partners must be dedicated to advancing open science as part of their mission, not just neutral parties whose tools happen to be useful to open science.
